<template>
  <div class="h-auto w-full px-20">
    <header class="flex justify-between w-full">
      ...
      <p class="pr-10">Price</p>
    </header>
    <hr class="w-full border-blue-200 dark:border-blue-600 mt-3 mb-5">
      ...
      <section v-for="(item) in items" class="flex justify-between w-full items-center h-auto p-2 border-blue-200 dark:border-blue-600 dark:bg-blue-900 bg-white">
        <div class="flex gap-5 h-auto w-auto">
          ...
          <div class="flex flex-col justify-between">
            <div class="flex flex-col gap-2 overflow-auto max-h-[14vh] max-w-[130vh]">
            ...
            <div class="text-xs flex justify-start items-center gap-3 font-semibold">
              ...
              <div class="flex justify-start items-center gap-x-1 text-red-500 cursor-pointer hover:opacity-50">
    ...
    <footer class="grid justify-end gap-3">
      <h1 class="text-lg"><span class="font-normal">Subtotal ({{ items.length }} items): </span><span class="font-bold">${{ subtotal }}</span></h1>
      <div class="flex justify-end">
        <UButton to="/cart/checkout" icon="i-bi-cart-check" label="Proceed to checkout" class="flex items-center rounded hover:opacity-50 gap-x-1 bg-blue-500 hover:bg-blue-500 dark:bg-yellow-500  dark:hover:bg-yellow-500 dark:hover:bg-opacity-80"/>
      </div>
    </footer>
  </div>
</template>
