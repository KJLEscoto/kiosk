  ...
  <div class="h-auto w-full">
    ...
    <div class="px-20">
      ...
      <section class="grid grid-cols-4 gap-4 text-blue-800 dark:text-blue-900 w-full">
        <nuxt-link v-for="(product, index) in products" :to="`/college/it/pants/${product.id}`" :key="index" class="border p-3 rounded bg-white flex flex-col justify-between gap-2">
