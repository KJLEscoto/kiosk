  ...
  <div class="h-auto w-full px-20">
    <header class="flex justify-between w-full">
      ...
      <div class="flex justify-between gap-2">
        ...
        <UButton to="/kiosk/cart/checkout" icon="i-bi-cart-check" label="Proceed to checkout" class="rounded bg-yellow-600 hover:bg-yellow-600 hover:bg-opacity-50 dark:bg-yellow-500 dark:hover:bg-yellow-500 dark:hover:bg-opacity-50" />
      </div>
    </header>
